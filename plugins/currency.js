...
module.exports = bot => {
    ...
    cmd.command('compare')
        .action((meta, _currency1, _currency2) => {
            if (_currency1 == null || _currency2 == null) {
                return;
            }
            if (_currency1.includes('#') || _currency2.includes('#')) {
                return meta.reply('usage : ' + glados.main.prefix + ' currency anothercurrency')
            } //submitted by BlackofWorld (uppercase issue)
