        ...
        .action((meta) => {
            glados.main.db.all("SELECT serverid,discordid,rank FROM admins", function(err, rows) {
                ...
                rows.forEach(function(row) {
                    ...
                    if (row.serverid == meta.guild.id)
                        admins = admins + "<@" + row.discordid + "> (" + row.rank + ")\n";
                    else {}
                });
                meta.channel.sendMessage("", {
                    embed: {
                        color: glados.RandomText(3447003, 14365491, 3201849, 13818670, 13577435, 7089371, 14383916), //rnd_selection(3447003, 14365491, 3201849, 13818670, 13577435, 7089371, 14383916),
                        author: {
